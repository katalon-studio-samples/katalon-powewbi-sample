...
WebUI.click(findTestObject('OR PowerAppsportal/Page_New Flagging Request Partner Portal/span_Launch lookup modal_fa fa-search'))
...
WebUI.click(findTestObject('OR PowerAppsportal/Page_New Flagging Request Partner Portal/button_Select'))
...
'First Search'
WebUI.click(findTestObject('OR PowerAppsportal/Page_New Flagging Request Partner Portal/span_Launch lookup modal_fa fa-search (1)'))

WebUI.delay(5)

not_run: WebUI.switchToFrame(findTestObject('OR PowerAppsportal/Page_New Flagging Request Partner Portal/iframe_test'), 
    10)

value = WebUI.getAttribute(findTestObject('OR PowerAppsportal/Page_New Flagging Request Partner Portal/text_name'), 'data-value')

println(value)

name = WebUI.getText(findTestObject('OR PowerAppsportal/Page_New Flagging Request Partner Portal/text_name'))

println(name)

WebUI.click(findTestObject('OR PowerAppsportal/Page_New Flagging Request Partner Portal/span_sort descending_fa fa-fw (1)'))

WebUI.delay(5)

WebUI.clickOffset(findTestObject('OR PowerAppsportal/Page_New Flagging Request Partner Portal/button_Select (1)'), 0, 0)
